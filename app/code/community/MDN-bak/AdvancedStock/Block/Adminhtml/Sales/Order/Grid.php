...
class MDN_AdvancedStock_Block_Adminhtml_Sales_Order_Grid extends MageWorx_Adminhtml_Block_Orderspro_Sales_Order_Grid
{
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()
        	->addItem('validate_payment', array(
             ...
             'url'  => $this->getUrl('AdvancedStock/Misc/Validatepayment'),))
        	->addItem('cancel_payment', array(
             'label'=> Mage::helper('AdvancedStock')->__('Cancel payment'),
             'url'  => $this->getUrl('AdvancedStock/Misc/Cancelpayment'),))
        ;
