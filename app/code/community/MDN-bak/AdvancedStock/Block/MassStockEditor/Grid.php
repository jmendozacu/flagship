...
class MDN_AdvancedStock_Block_MassStockEditor_Grid extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    protected function _prepareColumns() {
        ...
        $this->addColumn('stock_mini', array(
            'header' => Mage::helper('AdvancedStock')->__('Stock mini'),
            'index' => 'stock_mini',
            'filter' => false,
            'sortable' => false,
            'renderer' => 'MDN_AdvancedStock_Block_MassStockEditor_Widget_Grid_Column_Renderer_StockMini',
            'align' => 'center'
        ));
