...
class MDN_Scanner_Block_Inventory_FreeDelivery extends Mage_Adminhtml_Block_Widget_Form
{
	...
	//print_r($product);
        ...
        else
        {
           ...
           //$warehouseId = Mage::getStoreConfig('scanner/free_delivery/warehouse',$location);
		//echo '____'.$warehouseId.'_____';
         $warehouseId = $location; //This needs some feedback
            ...
            if (!$stockItem)
            {
                $this->_errorMessage = $this->__('Stock item doesnt exist !');
                return false;
            }
