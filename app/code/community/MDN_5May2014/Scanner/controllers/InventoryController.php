...
class MDN_Scanner_InventoryController extends Mage_Adminhtml_Controller_Action {
	...
	public function processSearchAction() {
		...
		// ARUN KILL 
		//$model = Mage::getModel('AdvancedStock/ProductSerial')->getCollection();
		//echo "<pre>"; print_r($model->getData()); echo"</pre>";exit();
		// ARUN KILL 

		/** TODO: needs to search by ERP barcode, Serials module serial, or UPC (in that order) */
