...
class MDN_Purchase_Model_OrderProduct extends Mage_Core_Model_Abstract {
    ...
    public function getRowTotal() {
        $value = ($this->getpop_price_ht() + $this->getpop_eco_tax()) * $this->getpop_qty();
        $value = $value * (1 - $this->getpop_discount() / 100);
    ...
    public function getRowTotal_base() {
        $value = ($this->getpop_price_ht_base() + $this->getpop_eco_tax_base()) * $this->getpop_qty();
        $value = $value * (1 - $this->getpop_discount() / 100);
        return round($value, 2);
    }
