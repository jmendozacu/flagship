...
class MDN_Purchase_Block_Order_Edit_Tabs_Serials extends Mage_Adminhtml_Block_Widget_Grid {
	...
	protected function _prepareCollection() {
		$collection = Mage::getModel('AdvancedStock/ProductSerial')
				...
				//->join('cataloginventory/stock_item', 'product_id=entity_id', 'shelf_location')
	...
	public function getGridUrl() {
		return $this->getUrl('Purchase/Orders/ProductSerialsGrid', array('_current' => true, 'po_num' => $this->getOrder()->getId()));
	}
