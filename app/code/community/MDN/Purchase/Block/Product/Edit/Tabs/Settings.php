...
class MDN_Purchase_Block_Product_Edit_Tabs_Settings extends Mage_Adminhtml_Block_Widget_Form {
    ...
    /**
     * Retourne un combo pour d�finir le taux de tva pour les achats
     *
     */
    public function getDefaultPurchaseTaxRateCombo($name) {
        ...
        //Ajoute le premier �l�ment (default)
    ...
    public function getRefreshSupplyNeedUrl() {
        return $this->getUrl('Purchase/SupplyNeeds/RefreshProduct', array('product_id' => $this->getProduct()->getId()));
    }
