...
class MDN_SalesOrderPlanning_Block_ProductAvailabilityStatus_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
   ...
   /**
            ...
            array(
                ...
                'actions'   => array(
                    array(
                        ...
                        'url'     => array('base'=>'SalesOrderPlanning/ProductAvailabilityStatus/RefreshProduct'),
                        'field'   => 'product_id'
                    )
                ),
                'filter'    => false,
    ...
    {
    	return $this->getUrl('SalesOrderPlanning/ProductAvailabilityStatus/RefreshAll');
    }
	...
	{
		return $this->getUrl('SalesOrderPlanning/ProductAvailabilityStatus/RefreshOnlyMissing');
	}
