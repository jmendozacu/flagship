...
abstract class MDN_Orderpreparation_Model_Pdf_Pdfhelper extends Mage_Sales_Model_Order_Pdf_Abstract {
    ...
    public function drawFooter(&$page) {
        ...
        $this->DrawMultilineText($page, Mage::getStoreConfig('purchase/general/footer_text'), 20, $this->_BLOC_FOOTER_HAUTEUR, 10, 0, 15, false);
    }
    ...
    public function drawHeader(&$page, $title, $StoreId = null) {
        ...
        $this->drawTextInBlock($page, $name, 0, $this->y, $this->_PAGE_WIDTH, 50, 'l');
    ...
    public function FormatAddress($adress, $caption = '', $show_details = false, $NoTvaIntraco = '') {
        ...
        if ($adress != null) {
            ...
            $FormatedAddress .= $adress->getCity() . ', ' . $adress->getRegion() . ' ' . $adress->getPostcode() . "\n ";
