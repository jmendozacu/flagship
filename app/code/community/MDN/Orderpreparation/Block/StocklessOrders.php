 ...
 *
 */
class MDN_OrderPreparation_Block_StocklessOrders extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    {
        parent::__construct();
        $this->setId('StocklessOrdersGrid');
        ...
        $this->setVarNameFilter('orderpreparation_stockless');
    ...
    protected function _prepareColumns()
    {
        ...
        Mage::dispatchEvent('orderpreparartion_stockless_createcolums', array('grid'=>$this));
    ...
    {
        return $this->getUrl('*/*/StocklessOrderGrid', array('_current'=>true));
    }
    ...
    {
    	$retour = '';
    	$collection = Mage::getSingleton('Orderpreparation/ordertoprepare')->getStockLessOrdersFromCache();
