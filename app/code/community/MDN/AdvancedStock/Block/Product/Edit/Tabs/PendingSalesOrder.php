 ...
 */
class MDN_AdvancedStock_Block_Product_Edit_Tabs_PendingSalesOrder extends Mage_Adminhtml_Block_Widget_Grid
{
	/**
	 * Product get/set
	 *
   ...
   /**
    ...
    {
        return $this->getUrl('AdvancedStock/Products/CustomerPendingOrdersGrid', array('_current'=>true, 'product_id' => $this->getProduct()->getId()));
    }
