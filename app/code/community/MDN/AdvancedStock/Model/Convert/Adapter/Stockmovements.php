...
class MDN_AdvancedStock_Model_Convert_Adapter_StockMovements extends Mage_Dataflow_Model_Convert_Container_Abstract
{
    ...
    {
		$this->_collection = mage::getModel('AdvancedStock/StockMovement')    
			->getCollection()
