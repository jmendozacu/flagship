...
class MDN_AdvancedStock_Model_Pdf_BarcodeLabels extends MDN_AdvancedStock_Model_Pdf_Pdfhelper
{
    ...
    protected function printLabel($product)
    {
    	...
    	//draw product name
    	$this->_currentPage->setFont(Zend_Pdf_Font::fontWithName(Zend_Pdf_Font::FONT_HELVETICA), 12);
    	...
    	//draw sku
    	$this->_currentPage->setFont(Zend_Pdf_Font::fontWithName(Zend_Pdf_Font::FONT_HELVETICA_ITALIC), 10);
    ...
    protected function prepareForNextLabel()
    {
		...
		{
			if (($this->getLabelY() - $this->_labelHeight) < 0)
				$this->newPage();
		}
    }
