 ...
 */
include_once('MageWorx/Adminhtml/controllers/Orderspro/Order/Abstract.php');

class MageWorx_Adminhtml_Orderspro_OrderController extends MageWorx_Adminhtml_Orderspro_Order_Abstract {
    ...
    public function massDeleteCompletelyAction() {        
        ...
        if ($count>0) Mage::getSingleton('adminhtml/session')->addSuccess(Mage::helper('orderspro')->__('Selected orders were completely deleted.'));
        $this->_redirect('*/*/');                
    }
...
//    }
    ...
    public function deleteInvoiceAction() {
        ...
        if ($orderId>0) {
            ...
            $write->query("UPDATE `".$coreResource->getTableName('sales_flat_order_item')."` SET `qty_invoiced` = 0 WHERE `order_id` = ".$orderId);
        }
