...
class MageWorx_Adminhtml_Block_OrdersPro_Sales_Order_Grid_Renderer_Registry extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract {
    ...
    public function render(Varien_Object $row) {
        ...
        switch ($index) {
            case 'method': $registry = 'payment_methods';
                break;
            case 'shipping_method': $registry = 'shipping_methods';
                break;
            case 'customer_group_id': $registry = 'customer_groups';
                break;
            case 'shipped': $registry = 'shipped_statuses';
                break;
            case 'order_group_id': $registry = 'order_groups';
                break;
            case 'is_edited': $registry = 'edited_statuses';
                break;
            default : return '';
        }
