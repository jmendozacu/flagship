...
class MageWorx_OrdersPro_Model_SalesRule_Quote_Discount extends Mage_SalesRule_Model_Quote_Discount
{    
    ...
    protected function _transferOldItemDiscount($item) {        
        if (!Mage::helper('orderspro')->isEnabled() || !Mage::helper('orderspro')->isKeepPurchaseDiscount()) return $this;
