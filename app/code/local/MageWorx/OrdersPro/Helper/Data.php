...
class MageWorx_OrdersPro_Helper_Data extends Mage_Core_Helper_Abstract {
    ...
    public function getOrderGroups() {
        ...
        $orderGroups = Mage::getResourceModel('orderspro/order_group_collection')->load()->toOptionArray();        
    ...
    public function getShippedStatuses() {
        ...
        $statuses = array('1'=>Mage::helper('orderspro')->__('Yes'), '0'=>Mage::helper('orderspro')->__('No'));         
