...
class Mirasvit_Advr_Block_Adminhtml_Catalog_Attributeset 
    extends Mirasvit_Advr_Block_Adminhtml_Catalog_Abstract
{
    ...
    public function getColumns()
    {
        $columns = array(
            'product_attribute_set_id' => array(
                ...
                'totals_label'    => 'Total',
                'filter'          => false,
                'frame_callback'  => array($this, 'frameCallbackAttributeSet'),
                'chart'           => true,
    ...
    {
        $url = $this->getUrl('advradmin/adminhtml_catalog/attributesetDetail', array(
                'attribute_set_id' => $row->getProductAttributeSetId(),
