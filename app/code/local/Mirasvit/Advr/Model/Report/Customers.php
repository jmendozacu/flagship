...
class Mirasvit_Advr_Model_Report_Customers extends Mirasvit_Advr_Model_Report_Abstract
{
    ...
    protected function _construct()
    {
        ...
        )->addColumn('customer_created_at', array(
                'label'      => false,
                'expression' => 'customer_entity_table.created_at',
                'table'      => 'customer/entity',
            )
        )->addColumn('last_order_at', array(
                'label'      => false,
        ...
        foreach($customerAttributes as $attrCode => $attrLabel) {
            if (isset($this->_columns['customer_'.$attrCode])) {
                continue;
            }

            $this->addColumn('customer_'.$attrCode, array(
                    'label'      => false,
        ...
        foreach($addressAttributes as $attrCode => $attrLabel) {
            if (isset($this->_columns['customer_address_'.$attrCode])) {
                continue;
            }

            $this->addColumn('customer_address_'.$attrCode, array(
                    'label'      => false,
