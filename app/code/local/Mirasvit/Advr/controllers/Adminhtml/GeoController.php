...
class Mirasvit_Advr_Adminhtml_GeoController extends Mirasvit_Advr_Controller_Report
{
	...
	{
		return Mage::getSingleton('admin/session')->isAllowed('advr/settings/import_geo');
	}
}