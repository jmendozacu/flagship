<?php
define('Newline',"<br />");
class Ecommerceguys_Inventorymanager_Model_Fedexcommon
{
 ...
 */  
	public function printFault($exception, $client) {
	    ...
	    Mage::log($client, null, "fedex.log");
 ...
 */
	public function getProperty($var){
	    ...
	    if($var == 'password') Return 'VeuWzKfcCVUdJ8NVK3mxTnmi5'; 
	    ...
	    if($var == 'spodshipdate') Return '2015-11-21';
	    if($var == 'serviceshipdate') Return '2015-11-26';
	
	    if($var == 'readydate') Return '2015-11-26T08:44:07';
	    ...
	    if($var == 'expirationdate') Return '2015-11-24';
	    if($var == 'begindate') Return '2015-11-22';
	    if($var == 'enddate') Return '2015-11-25';  
	    ...
	    if($var == 'shipper') Return array(
	        'Contact' => array(
	            'PersonName' => 'Victor Jones',
	            'CompanyName' => 'agilizelabs',
