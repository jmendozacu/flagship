...
class Ecommerceguys_Inventorymanager_Model_Status
{
	...
	public function toOptionArray(){
		return array(
			...
			array('value'=>'partial', 'label'=>Mage::helper('inventorymanager')->__("Partial Shipped")),
			array('value'=>'complete', 'label'=>Mage::helper('inventorymanager')->__("Fully Shipped")),
	...
	public function getValues(){
		return array(
			...
			'partial'=> Mage::helper('inventorymanager')->__("Partial Shipped"),
			'complete'=> Mage::helper('inventorymanager')->__("Fully Shipped"),
