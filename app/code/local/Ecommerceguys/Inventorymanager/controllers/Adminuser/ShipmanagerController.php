...
//require_once(Mage::getBaseDir() . '/FPDI/fpdf.php');
//require_once(Mage::getBaseDir() . '/FPDI/fpdi.php');
...
class Ecommerceguys_Inventorymanager_Adminuser_ShipmanagerController extends Mage_Core_Controller_Front_Action
{
            ...
            foreach ($data['serial_key'] as $key => $serialKey) {
                ...
                try {
                    ...
                    try {
                        ...
                        $historyObject->setData($historyData)->setData('po', $data['po'])->save();
	...
	//$block = $this->getLayout()->createBlock('core/template')->setTemplate('inventorymanager/adminuser/shipmanager/show.phtml');
