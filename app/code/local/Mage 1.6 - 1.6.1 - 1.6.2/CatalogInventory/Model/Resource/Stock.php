...
class Mage_CatalogInventory_Model_Resource_Stock extends Mage_Core_Model_Resource_Db_Abstract
{
    ...
    public function setInStockFilterToCollection($collection)
    {
        ...
        $cond = array(
            '{{table}}.use_config_manage_stock = 0 AND {{table}}.manage_stock=1 AND {{table}}.is_in_stock=1  and stock_id = 1',
            '{{table}}.use_config_manage_stock = 0 AND {{table}}.manage_stock=0 and stock_id = 1'
        );

        if ($manageStock) {
            $cond[] = '{{table}}.use_config_manage_stock = 1 AND {{table}}.is_in_stock=1  and stock_id = 1';
        } else {
            $cond[] = '{{table}}.use_config_manage_stock = 1  and stock_id = 1';
        }
