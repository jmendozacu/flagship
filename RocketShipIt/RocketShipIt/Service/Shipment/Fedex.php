...
class Fedex extends \RocketShipIt\Service\Common
{
    ...
    public function simplifyFEDEXResponse($xmlArray)
    {
        ...
        if (isset($xmlArray['ProcessShipmentReply']['CompletedShipmentDetail']['CompletedPackageDetails']['TrackingIds']['TrackingNumber'])) {
            $simpleArr['tracking_id'] = $xmlArray['ProcessShipmentReply']['CompletedShipmentDetail']['CompletedPackageDetails']['TrackingIds']['TrackingNumber'];
        } else {
            foreach ($xmlArray['ProcessShipmentReply']['CompletedShipmentDetail']['CompletedPackageDetails']['TrackingIds'] as $tracking) {
                $simpleArr['tracking_id'][] = $tracking['TrackingNumber'];
            }
        }
        ...
        $simpleArr['label_img'] = $xmlArray['ProcessShipmentReply']['CompletedShipmentDetail']['CompletedPackageDetails']['Label']['Parts']['Image'];

        if (isset($xmlArray['ProcessShipmentReply']['CompletedShipmentDetail']['CompletedPackageDetails']['CodReturnDetail']['Label']['Parts']['Image'])) {
            $simpleArr['cod_return_label_img'] = $xmlArray['ProcessShipmentReply']['CompletedShipmentDetail']['CompletedPackageDetails']['CodReturnDetail']['Label']['Parts']['Image'];
        }

        if (isset($xmlArray['ProcessShipmentReply']['CompletedShipmentDetail']['AssociatedShipments']['Label']['Parts']['Image'])) {
            $simpleArr['cod_return_label_img'] = $xmlArray['ProcessShipmentReply']['CompletedShipmentDetail']['AssociatedShipments']['Label']['Parts']['Image'];
        }
